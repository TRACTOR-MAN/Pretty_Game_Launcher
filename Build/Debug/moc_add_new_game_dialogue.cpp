...
QT_MOC_LITERAL(3, 35, 9), // "newString"
QT_MOC_LITERAL(4, 45, 13), // "searchForFile"
QT_MOC_LITERAL(5, 59, 18), // "updateSelectedFile"
QT_MOC_LITERAL(6, 78, 12) // "selectedFile"

    },
    "Add_New_Game_Dialogue\0textChanged\0\0"
    "newString\0searchForFile\0updateSelectedFile\0"
    "selectedFile"
};
...
void Add_New_Game_Dialogue::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->searchForFile(); break;
        case 2: _t->updateSelectedFile((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Add_New_Game_Dialogue::textChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Add_New_Game_Dialogue::textChanged(const QString _t1)
{
